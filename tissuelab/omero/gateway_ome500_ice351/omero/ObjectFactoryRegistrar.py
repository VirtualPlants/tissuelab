...
class FilesetVersionInfoObjectFactory(Ice.ObjectFactory):

    from omero_model_FilesetVersionInfoI import FilesetVersionInfoI

    def create(self, type):
        return self.FilesetVersionInfoI()
...
def registerObjectFactory(ic, client = None):
    ...
    conditionalAdd("::omero::model::FilesetVersionInfo", ic,  FilesetVersionInfoObjectFactory())
