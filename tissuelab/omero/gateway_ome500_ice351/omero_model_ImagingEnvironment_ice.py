...
if 'ImagingEnvironment' not in _M_omero.model.__dict__:
    ...
    _M_omero.model._t_ImagingEnvironment = IcePy.defineClass('::omero::model::ImagingEnvironment', ImagingEnvironment, -1, (), True, False, _M_omero.model._t_IObject, (), (
        ...
        ('_temperature', (), _M_omero._t_RDouble, False, 0),
        ('_airPressure', (), _M_omero._t_RDouble, False, 0),
    ...
    ImagingEnvironment._op_getTemperature = IcePy.Operation('getTemperature', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_omero._t_RDouble, False, 0), ())
    ImagingEnvironment._op_setTemperature = IcePy.Operation('setTemperature', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_omero._t_RDouble, False, 0),), (), None, ())
    ImagingEnvironment._op_getAirPressure = IcePy.Operation('getAirPressure', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_omero._t_RDouble, False, 0), ())
    ImagingEnvironment._op_setAirPressure = IcePy.Operation('setAirPressure', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_omero._t_RDouble, False, 0),), (), None, ())
