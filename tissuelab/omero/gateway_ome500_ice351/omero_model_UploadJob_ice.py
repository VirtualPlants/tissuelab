...
if 'UploadJob' not in _M_omero.model.__dict__:
    ...
    _M_omero.model._t_UploadJob = IcePy.defineClass('::omero::model::UploadJob', UploadJob, -1, (), True, False, _M_omero.model._t_Job, (), (('_versionInfo', (), _M_omero.model._t_FilesetVersionInfo, False, 0),))
    UploadJob._ice_type = _M_omero.model._t_UploadJob

    UploadJob._op_getVersionInfo = IcePy.Operation('getVersionInfo', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_omero.model._t_FilesetVersionInfo, False, 0), ())
    UploadJob._op_setVersionInfo = IcePy.Operation('setVersionInfo', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_omero.model._t_FilesetVersionInfo, False, 0),), (), None, ())
