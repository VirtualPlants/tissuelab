...
if 'IUpdate' not in _M_omero.api.__dict__:
    ...
    IUpdate._op_indexObject = IcePy.Operation('indexObject', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (((), _M_omero.model._t_IObject, False, 0),), (), None, (_M_omero._t_ServerError,))
