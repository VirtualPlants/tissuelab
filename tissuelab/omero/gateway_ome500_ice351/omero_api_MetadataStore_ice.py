...
if 'MetadataStore' not in _M_omero.api.__dict__:
    ...
    MetadataStore._op_setPixelsParams = IcePy.Operation('setPixelsParams', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, None, (), (((), IcePy._t_long, False, 0), ((), IcePy._t_bool, False, 0), ((), _M_omero.api._t_StringStringMap, False, 0)), (), None, (_M_omero._t_ServerError,))
